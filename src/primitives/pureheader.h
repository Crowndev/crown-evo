...
#ifndef PRIMITIVES_PUREHEADER_H
#define PRIMITIVES_PUREHEADER_H
...
public:
    ...
    SERIALIZE_METHODS(CBlockVersion, obj) {
    ...
    inline int32_t GetAuxPowVersion() const { return VERSION_AUXPOW; }
